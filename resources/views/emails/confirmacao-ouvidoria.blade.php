        ...
        <tr>
            <td  style="padding: 40px 30px 40px 30px;">
               <table cellpadding="0" cellspacing="0" width="100%">
                   <tr>
                        <td>
                            <p style="font-family: 'Open Sans', sans-serif;color: rgb(92, 86, 86);font-weight: 300; font-size: 21px;">Recebemos a sua solicitação.</p>
                        </td>
                   </tr>
                   <tr>
                        <td>
                            <p style="font-family: 'Open Sans', sans-serif;color: rgb(92, 86, 86);font-weight: 300; font-size: 19px;">O número do protocolo de atendimento é: {{ $protocolo }}. Em breve entraremos em contato.</p>
                        </td>
                   </tr>
                   <tr>
